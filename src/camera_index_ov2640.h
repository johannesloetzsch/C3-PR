...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  /* When connected directly (port 80), port 81 is used for streaming. However when using c3pr-proxy, the same port as for opening this page will be used. */
  var streamPort = document.location.port === '' ? '81' : document.location.port
  var streamUrl = document.location.protocol + '//' + document.location.hostname + ':' + streamPort
